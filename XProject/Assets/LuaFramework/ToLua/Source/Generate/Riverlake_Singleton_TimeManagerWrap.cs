...
public class Riverlake_Singleton_TimeManagerWrap
{
	...
	static int DestroySelf(IntPtr L)
	{
		try
		{
			...
			Riverlake.Singleton<TimeManager>.DestroySelf();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.PushSealed(L, Riverlake.Singleton<TimeManager>.Instance);
			return 1;
		}
		catch (Exception e)
		{
