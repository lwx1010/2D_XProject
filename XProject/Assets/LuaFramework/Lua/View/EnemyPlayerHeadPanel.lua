...
function EnemyPlayerHeadPanel.Awake(obj)
	...
	this.widgets = {
		{field="BtnVerysamll",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll",src=LuaButton, onClick = function (gObj)  --[===[todo click]===]  end },
		{field="KuangShiQiCaiChenDuX",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll.KuangShiQiCaiChenDuX",src=LuaText},
		{field="116",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll.DengJi.116",src=LuaText},
		{field="BtnVerysamll",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll",src=LuaButton, onClick = function (gObj)  --[===[todo click]===]  end },
		{field="KuangShiQiCaiChenDuX",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll.KuangShiQiCaiChenDuX",src=LuaText},
		{field="116",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll.DengJi.116",src=LuaText},
		{field="BtnVerysamll",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll",src=LuaButton, onClick = function (gObj)  --[===[todo click]===]  end },
		...
		{field="KuangShiQiCaiChenDuX",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll.KuangShiQiCaiChenDuX",src=LuaText},
		{field="116",path="zhujiemian_diduiwanj.DiDuiWanJia.BtnVerysamll.DengJi.116",src=LuaText},
		{field="DianJiWanJiaTouXiang",path="zhujiemian_diduiwanj.DiDuiWanJia.TiShi.DianJiWanJiaTouXiang",src=LuaText},
