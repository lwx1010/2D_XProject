...
namespace Toqe.Downloader.Business.Observer
{
    public class DownloadToFileSaver : AbstractDownloadObserver
    {
        ...
        public delegate void FileWriteExceptionHandler(Exception e);

        private FileWriteExceptionHandler exceptionHandler;

        public DownloadToFileSaver(string filename, FileWriteExceptionHandler handler)
        {
