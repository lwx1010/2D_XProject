...
namespace Toqe.Downloader.Business.DownloadBuilder
{
    public class MultiPartDownloadBuilder : IDownloadBuilder
    {
        ...
        {
            return new MultiPartDownload(url, bufferSize, this.numberOfParts, offset, this.downloadBuilder, this.requestBuilder, this.downloadChecker, this.alreadyDownloadedRanges);
        }
    }
}