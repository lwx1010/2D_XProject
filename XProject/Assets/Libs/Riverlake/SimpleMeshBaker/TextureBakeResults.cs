...
namespace AL.SMB
{
    ...
    public class AtlasesAndRects{
	    ...
	    public List<MaterialAndUVRect> mat2rect_map;
    ...
    public class MaterialAndUVRect
    {
        ...
        public MaterialAndUVRect(Material m, Rect destRect, Rect samplingRectMatAndUVTiling, Rect sourceMaterialTiling, Rect samplingEncapsulatinRect, string objName)
        {
            material = m;
            atlasRect = destRect;
        ...
        public override bool Equals(object obj)
        {
            ...
            return (material == ((MaterialAndUVRect)obj).material && samplingEncapsulatinRect == ((MaterialAndUVRect)obj).samplingEncapsulatinRect);
        }
    }
    ...
    public class TextureBakeResults {
