...
static public class EngineMath
{
	/// <summary>
	...
	static public Rect ConvertToTexCoords (Rect rect, int width, int height)
	{
		...
		if (width != 0f && height != 0f)
		{
            ...
            final.xMin = rect.xMin / width + halfPixelWidth;
			final.xMax = rect.xMax / width - halfPixelWidth;
			final.yMin = 1f - rect.yMax / height + halfPixelHeight;
			final.yMax = 1f - rect.yMin / height - halfPixelHeight;
		}
		return final;
	}
