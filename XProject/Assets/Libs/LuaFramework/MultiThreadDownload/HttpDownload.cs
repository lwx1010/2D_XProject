...
//                return Mathf.Max(Environment.ProcessorCount - 1, 1);
        ...
        {
            Debug.LogFormat("[Main]", "HttpDownload.AddFile {0}", file);
        ...
        {
            Debug.LogFormat("[Main]", "HttpDownload.RemoveFile Before {0}, waitFileList.Count={1}, loadSizeFileList.Count={2}", file, waitFileList.Count, loadSizeFileList.Count);
            ...
            Debug.LogFormat("[Main]", "HttpDownload.RemoveFile RemoveComplete {0}, waitFileList.Count={1}, loadSizeFileList.Count={2}", file, waitFileList.Count, loadSizeFileList.Count);


            CheckLoadSizeThreadStart();
            CheckLoadThreadStart();

            Debug.LogFormat("[Main]", "HttpDownload.RemoveFile End {0}, waitFileList.Count={1}, loadSizeFileList.Count={2}", file, waitFileList.Count, loadSizeFileList.Count);
        ...
        private void CheckLoadSizeThreadStart()
        {
            ...
            Debug.LogFormat("[Main]", "HttpDownload.CheckLoadSizeThreadStart waitFileList.Count={0}, loadSizeThread.state={1}", waitFileList.Count, loadSizeThread.state);
        ...
        {
            Debug.LogFormat("[Main]", "HttpDownload.CheckLoadThreadStart waitBlockList.Count={0}", waitBlockList.Count);
        ...
        public class LoadThread
        {
            ...
            public void Start()
            {
                ...
                Debug.LogFormat("[LoadThread]", "Start Before {0}", this);
                ...
                Debug.LogFormat("[LoadThread]", "Start After {0}", this);
            }
        ...
        public class LoadSizeThread
        {
            ...
            public void Start()
            {
                ...
                Debug.LogFormat("[LoadSizeThread]", "Start Before {0}", this);
                ...
                Debug.LogFormat("[LoadSizeThread]", "Start After {0}", this);
            }


            public void Exit()
            {
                Debug.LogFormat("[LoadSizeThread]", "Exit Before {0}", this);
                ...
                Debug.LogFormat("[LoadSizeThread]", "Exit After {0}", this);
            }
            ...
            private void Run()
            {
                while(!isExit)
                {
                    ...
                    Debug.LogFormat("[LoadSizeThread]", "Run Doing Before {0}, httpDownload.waitFileList.Count={1}, httpDownload.loadSizeFileList.Count={2}", this, httpDownload.waitFileList.Count, httpDownload.loadSizeFileList.Count);
                    ...
                    Debug.LogFormat("[LoadSizeThread]", "Run Doing After {0}, httpDownload.waitFileList.Count={1}, httpDownload.loadSizeFileList.Count={2}", this, httpDownload.waitFileList.Count, httpDownload.loadSizeFileList.Count);
                }

                state = StateType.End;
                thread = null;

                Debug.LogFormat("[LoadSizeThread]", "Run End {0}", this);
            }
