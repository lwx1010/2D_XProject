...
namespace UnityEditor.XCodeEditor
{
	public partial class XCProject : System.IDisposable
	{
		...
		{	
            ...
            Debug.Log("Adding extend-files...");
            foreach (string filePath in mod.extend_files)
            {
            ...
            Debug.Log("Adding extend-folders...");
            foreach (string folderPath in mod.extend_folders)
            {
                string absoluteFolderPath = System.IO.Path.Combine(this.projectRootPath, folderPath);
                Debug.Log("Adding extend-folder " + absoluteFolderPath);
                this.AddFolder(absoluteFolderPath, modGroup, (string[])mod.excludes.ToArray(typeof(string)));
            }
