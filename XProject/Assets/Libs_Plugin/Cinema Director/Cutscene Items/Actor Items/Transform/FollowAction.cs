...
namespace CinemaDirector
{
    ...
    /// </summary>
    [CutsceneItem("Common", "Follow", CutsceneItemGenre.ActorItem, CutsceneItemGenre.TransformItem)]
    public class FollowAction : CinemaActorAction, IRevertable
    {
        ...
        private Transform cacheTargetTrans;
        
        public Transform CacheTargetTrans
        {
            get
            {
                if (cacheTargetTrans == null && this.LookAtTarget != null)
                    cacheTargetTrans = this.LookAtTarget.transform;
                return cacheTargetTrans;
            }
        }
        /// <summary>
        ...
        public override void Trigger(GameObject actor)
        {
            ...
            actor.transform.LookAt(CacheTargetTrans);

            actor.transform.position = CacheTargetTrans.position - Distance;
        }
        ...
        public override void UpdateTime(GameObject actor, float runningTime, float deltaTime)
        {
            ...
            actor.transform.position = Vector3.Slerp(actor.transform.position, CacheTargetTrans.position - Distance, deltaTime);
        }
