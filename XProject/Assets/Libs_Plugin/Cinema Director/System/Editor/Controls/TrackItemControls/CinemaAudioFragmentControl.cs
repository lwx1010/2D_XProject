...
[CutsceneItemControlAttribute(typeof(CinemaAudioFragment))]
public class CinemaAudioFragmentControl : ActionFixedItemControl
{
    private string audioItemName = string.Empty;
    private Texture2D texture = null;

    public CinemaAudioFragmentControl()
    {
    ...
    {
        CinemaAudioFragment audioItem = e.actionItem as CinemaAudioFragment;
    ...
    {
        CinemaAudioFragment audioItem = Wrapper.Behaviour as CinemaAudioFragment;
        if (audioItem == null) return;
