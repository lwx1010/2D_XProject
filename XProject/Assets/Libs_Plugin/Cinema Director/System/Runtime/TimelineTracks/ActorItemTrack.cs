...
namespace CinemaDirector
{
    ...
    /// </summary>
    [TimelineTrackAttribute("Actor Track", new TimelineTrackGenre[] { TimelineTrackGenre.ActorTrack, TimelineTrackGenre.MultiActorTrack , TimelineTrackGenre.UTestTrack,  }, CutsceneItemGenre.ActorItem)]
    public class ActorItemTrack : TimelineTrack, IActorTrack, IMultiActorTrack
    {
        ...
        public List<Transform> Actors
        {
            get
            {
                ...
                if (trackGroup != null && trackGroup.Actor != null)
                {
                    actors.Add(trackGroup.Actor);
                    return actors;
                }

                UTestTrackGroup uTestTrackGroup = TrackGroup as UTestTrackGroup;
                if (uTestTrackGroup != null && uTestTrackGroup.Actor != null)
                {
                    actors.Add(uTestTrackGroup.Actor);
                    return actors;
                }
                ...
                {
                    actors.AddRange(multiActorTrackGroup.Actors);
                }
                return actors;
            }
        }
