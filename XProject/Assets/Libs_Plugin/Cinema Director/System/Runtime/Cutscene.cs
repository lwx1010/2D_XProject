...
namespace CinemaDirector
{
    ...
    public class Cutscene : MonoBehaviour, IOptimizable
    {
        #region Fields
        [SerializeField]
        private bool debug; // debug of cutscene play.
        ...
        // Event fired when Cutscene has been played.
        public event CutsceneHandler CutscenePlayed;
        ...
        private IEnumerator freshPlay()
        {
            ...
            if (CutscenePlayed != null)
                CutscenePlayed.Invoke(this, null);
        }
