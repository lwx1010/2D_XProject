...
public class ShaderForgeMaterialInspector : MaterialEditor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (isVisible && !theShader.hasMultipleDifferentValues && theShader.objectReferenceValue != null)
        {
            ...
            if (GUILayout.Button("用 Shader Forge 打开着色器"))
            {
            ...
            mat.globalIlluminationFlags = (MaterialGlobalIlluminationFlags)EditorGUILayout.EnumPopup("自发光全局照明", mat.globalIlluminationFlags);
