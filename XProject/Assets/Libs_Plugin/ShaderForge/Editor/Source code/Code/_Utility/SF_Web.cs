...
namespace ShaderForge
{
    public static class SF_Web
    {
        ...
        const string urlcnmanual = "https://millionart.gitbooks.io/shader-forge-chinese-manual-unofficial/content/";
        ...
        static void OpenDocumentationForString(string s)
        {
            ...
            Application.OpenURL(urlcnmanual + "?q=" + StripExtraChars(s));
        }
