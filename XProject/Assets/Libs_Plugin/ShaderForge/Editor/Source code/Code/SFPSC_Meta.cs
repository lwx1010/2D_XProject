...
namespace ShaderForge
{
    ...
    public class SFPSC_Meta : SFPS_Category
    {
        ...
        public string[] strInspector3DPreviewType = new string[] { "3D  对象", "2D 切片", "天空" };
        public enum BatchingMode { Enabled, Disabled, DisableDuringLODFade };
        public string[] strBatchingMode = new string[] { "启用", "禁用", "细节层次（LOD）减淡过程中禁用" };
		...
		*/
        ...
        public override float DrawInner(ref Rect r)
        {
            ...
            EditorGUI.LabelField(r, "途径", EditorStyles.miniLabel);
            r.xMin += 30;
            r.height = 17;
            r.xMax -= 3;
            ...
            EditorGUI.LabelField(r, "备用", EditorStyles.miniLabel);
            ...
            EditorGUI.LabelField(r, "细节层次（LOD）", EditorStyles.miniLabel);
            r.xMin += 80;
            r.height = 17;
            r.xMax -= 3;
            ...
            canUseSpriteAtlas = UndoableToggle(r, canUseSpriteAtlas, "允许使用图集切片", "allow using atlased sprites", null);
            r.y += 20;

            batchingMode = (BatchingMode)UndoableLabeledEnumPopupNamed(r, "Draw call 批处理", batchingMode, strBatchingMode, "draw call batching");
            r.y += 20;

            previewType = (Inspector3DPreviewType)UndoableLabeledEnumPopupNamed(r, "Inspector 预览模式", previewType, strInspector3DPreviewType, "inspector preview mode");
            r.y += 20;
            ...
            if (cgIncludes.Count == 0)
            {
                ...
                rBtn.height -= 4;
                rBtn.width = 100;
                if (GUI.Button(rBtn, "添加 CG 包括", EditorStyles.miniButton))
                {
