...
public class UITextureInspector : UIBasicSpriteEditor
{
    ...
    protected override void DrawCustomProperties()
    {
        ...
        EditorGUILayout.LabelField("Adjust", GUILayout.Width(80F));
        if (GUILayout.Button("720 to 1080"))
        {
            mTex.SetDimensions((int)(mTex.width * UITexture.scaleRatio), (int)(mTex.height * UITexture.scaleRatio));
        }
    ...
    protected override bool ShouldDrawProperties()
    {
        ...
        {
            string path = AssetDatabase.GetAssetPath(sp.objectReferenceValue).ToLower();
        ...
        {
            texPathSP.stringValue = string.Empty;
