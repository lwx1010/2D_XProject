...
//#endif
    ...
    static public void MarkParentAsChangedEx(GameObject go)
    {
        UIWidget[] rects = go.GetComponentsInChildren<UIWidget>();
        for (int i = 1, imax = rects.Length; i < imax; ++i)
            rects[i].MarkAsChanged();
    }
