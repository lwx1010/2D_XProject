...
public class UILabel : UIWidget
{
    ...
    private static bool isInitMaxChars;
    /// <summary>
    /// 防止文字破碎
    /// </summary>
    private void FixBokenWord(UnityEngine.Font dynamicFont)
    {
        if (dynamicFont == null) return;
        
        if (!isInitMaxChars)
        {
            isInitMaxChars = true;
            TextAsset texAss = Resources.Load<TextAsset>("commonCharacter2000");
            dynamicFont.RequestCharactersInTexture(texAss.text);
        }
    }
}
