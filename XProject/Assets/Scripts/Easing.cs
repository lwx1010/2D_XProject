...
public static class Easing
{
	...
	/// <summary>
	/// Ease the specified easeType, value, start and end.
	/// </summary>
	/// <param name="easeType">Ease type.</param>
	/// <param name="value">0.0f ~ 1.0f</param>
	/// <param name="start">start</param>
	/// <param name="end">end</param>
	public static float ease(EaseType easeType, float value, float start = 0.0f, float end = 1.0f )
	{
		switch (easeType){
		...
		case EaseType.easeInOutBack:
			...
			return elastic(start, end, value);
			break;*/
